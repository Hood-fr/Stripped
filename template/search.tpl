<div class="titrePage">
	<div class="browsePath">
		<h2>
			...
			{$LEVEL_SEPARATOR}{'Search'|@translate}
		</h2>
	</div>
...
{* copied and modified from themes/default/template.search.tpl, starts here *}
...
{* copied and modified from themes/default/template.search.tpl, stops here *}
		</div>
	</div>
</div> <!-- content -->
